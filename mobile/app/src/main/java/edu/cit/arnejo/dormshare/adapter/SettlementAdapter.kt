...
class SettlementAdapter(private var items: List<Settlement>) : RecyclerView.Adapter<SettlementAdapter.VH>() {
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.tvSummary.text = "${s.fromUserId} → ${s.toUserId}: ${s.amount}"
